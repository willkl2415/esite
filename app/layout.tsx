...
export default function HomePage() {
  return (
    <main className="flex flex-col items-center justify-center w-full">
      {/* === Hero Section === */}
      <section className="relative w-full min-h-[80vh] flex items-center justify-center text-center bg-gradient-to-b from-black via-[#000100] to-[#1a1a1a] text-white">
        {/* Background overlay smoke effect */}
        <div className="absolute inset-0 z-0 opacity-30 bg-[url('/cigar-smoke-bg.jpg')] bg-cover bg-center" />
