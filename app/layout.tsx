...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      ...
      >
        {/* === Top Header Row === */}
        <div className="flex justify-between items-center px-8 py-4 border-b bg-white/70 backdrop-blur-md sticky top-0 z-50">
          {/* Left: Search with Icon */}
          <div className="flex items-center border rounded-full px-3 py-2 focus-within:ring-2 focus-within:ring-gray-400 w-64">
            <input
              type="text"
              placeholder="Search for products..."
              className="flex-1 outline-none text-sm"
            />
            <MagnifyingGlassIcon className="h-5 w-5 text-gray-500 cursor-pointer hover:text-black" />
          </div>
