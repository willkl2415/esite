  ...
  return (
    <div className="min-h-screen bg-[#ff9800] text-black p-10">
      <div className="max-w-4xl mx-auto bg-white rounded-2xl shadow-lg p-10">
        <h1 className="text-4xl font-bold mb-6">Cigars for Beginners</h1>
        <h2 className="text-2xl font-semibold mb-4">What You Should Consider</h2>
        <p className="mb-6">
          Stepping into the world of cigars can feel like entering a secret society. Rows of cedar boxes,
          exotic aromas, and an entirely new vocabulary can be overwhelming. But cigars aren’t meant to
          intimidate — they’re meant to be enjoyed. If you’re new to this timeless ritual, here’s your
          complete guide to starting with confidence.
        </p>

        <h3 className="text-xl font-semibold mt-6 mb-2">Let’s Start with Strength – Mild Is Your Friend</h3>
        <ul className="list-disc list-inside mb-6">
          <li>Mild-bodied cigars – smooth, creamy, approachable.</li>
        ...
        <p className="mb-6">
          Your first cigar should fit both your hand and your schedule. Shorter cigars (like Robustos
        ...
        <p className="mb-6">
          Early experiences should taste inviting, not intimidating. Look for blends that offer:
        </p>
        <ul className="list-disc list-inside mb-6">
          <li>Creamy or nutty notes</li>
          <li>Gentle cedar woodiness</li>
        ...
        <ul className="list-disc list-inside mb-6">
          <li>Ashton Classic – Creamy, balanced elegance.</li>
          <li>Macanudo Café – The world’s go-to mild cigar.</li>
          <li>Romeo y Julieta Reserva Real – Smooth with a gentle sweetness.</li>
        ...
        <ul className="list-disc list-inside mb-6">
          <li>A smooth wrapper with no cracks</li>
        ...
        <p className="mb-6">
          Cigars are about slowing down, savoring flavors, and enjoying moments — not about rushing or showing off.
          Start mild, ease into the ritual, and let your palate evolve naturally.
        </p>

        <h3 className="text-xl font-semibold mt-6 mb-2">✨ Beginner’s Starter Picks</h3>
        <ul className="list-disc list-inside mb-6">
          <li>Macanudo Café Robusto</li>
          <li>Romeo y Julieta Reserva Real Toro</li>
