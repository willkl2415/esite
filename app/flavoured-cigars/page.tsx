...
export default function FlavouredCigarDetailPage({ params }: { params: { id: string } }) {
  ...
  if (!product) {
    return (
      <div className="p-10 bg-[#ff9800] min-h-screen text-center">
        ...
        <Link href="/flavoured-cigars" className="text-purple hover:underline block mt-6">
    ...
    <div className="p-10 bg-[#ff9800] min-h-screen">
      <div className="max-w-4xl mx-auto bg-white rounded-lg shadow-lg p-8">
        ...
        <div className="text-center mt-8">
          <Link href="/flavoured-cigars" className="text-purple hover:underline">
            ← Back to Flavoured Cigars
          </Link>
        </div>
      </div>
