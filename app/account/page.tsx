...
export default function AccountPage() {
  return (
    <div className="p-10 max-w-6xl mx-auto">
      ...
      {/* === Login Section === */}
      <div className="bg-white shadow-lg rounded-xl p-8 border mb-12">
        <h2 className="text-2xl font-semibold mb-6">Existing Customers</h2>
        <form className="space-y-4 max-w-lg">
          ...
          <button
            type="submit"
            className="w-full bg-black text-white py-2 rounded-lg hover:bg-[#ff9800] hover:text-black transition"
          >
            Log In
          </button>
        </form>
